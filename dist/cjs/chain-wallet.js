...
class ChainWalletClient {
    ...
    constructor(opt) {
        ...
        switch (network) {
            case 'Devnet':
                ...
                this.coder = new anchor_1.BorshCoder(chain_wallet_json_1.default);
                break;
            case "Testnet":
            ...
            case "Mainnet":
                ...
                this.coder = new anchor_1.BorshCoder(chain_wallet_json_2.default);
                break;
        }
     ...
     * ```
     **/
    createEffectRole(filter, trigger) {
        return {
            filter: filter,
            ruleType: {
                effect: {}
     ...
     *    const ix = await client.managerRuleAddInstruction(wallet, [rule]);
     **/
    createTransferAmountRule(filter, trigger, amount) {
        const rule = { amount };
        return {
            filter: filter,
            ruleType: {
     ...
     * const ix = await client.managerRuleAddInstruction(wallet, [rule]);
     **/
    createTransferFreqRule(filter, trigger, params) {
        return {
            filter: filter,
            ruleType: {
                transferFreq: params
     ...
     * const ix = await client.managerRuleAddInstruction(wallet, [rule]);
     */
    createTransferFreqTimesRule(filter, trigger, params) {
        return {
            filter: filter,
            ruleType: {
     ...
     * const ix = await client.managerRuleAddInstruction(wallet, [rule]);
     */
    createTransactionParamsRule(filter, trigger, params) {
        return {
            filter: filter,
            ruleType: {
     ...
     * const ix = await client.managerRuleAddInstruction(wallet, [rule]);
     */
    createTransactionInvokeTimesRule(filter, trigger, params) {
        return {
            filter: filter,
            ruleType: {
